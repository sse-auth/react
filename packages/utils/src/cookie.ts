...
export function defaultCookies(useSecureCookies: boolean) {
  ...
  return {
    ...
    sessionToken: {
      name: `${cookiePrefix}sse-auth.react.session-token`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    callbackUrl: {
      name: `${cookiePrefix}sse-auth.react.callback-url`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    csrfToken: {
      ...
      name: `${useSecureCookies ? "__Host-" : ""}sse-auth.react.csrf-token`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    pkceCodeVerifier: {
      name: `${cookiePrefix}sse-auth.react.pkce.code_verifier`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    state: {
      name: `${cookiePrefix}sse-auth.react.state`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    nonce: {
      name: `${cookiePrefix}sse-auth.react.nonce`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    webauthnChallenge: {
      name: `${cookiePrefix}sse-auth.react.challenge`,
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
