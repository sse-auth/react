import { decode, encode } from "@sse-auth/utils/dist";
import type { CookiesOptions, Cookie } from "@sse-auth/types/utils";
import type { InternalOptions, RequestInternal, SSE_User } from "../types";
...
export const webauthnChallenge = {
  ...
  async use(
    ...
    if (!payload) throw new Error("WebAuthn challenge was missing");
