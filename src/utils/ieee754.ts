 ...
 * @param {boolean} isLE Whether the buffer is in little-endian byte order.
 * @param {number} mLen The length of the mantissa in bits.
 * @param {number} nBytes The total number of bytes in the floating point number.
 * @returns {number} The floating point number read from the buffer.
 */
...
/**
 * Writes a floating point number to a buffer.
 *
